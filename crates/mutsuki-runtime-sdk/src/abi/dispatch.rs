use mutsuki_runtime_wire::{AnyWireRequest, DecodedWireRequest, Opcode, decode_binary_any_request};
...
pub fn dispatch_host_request(
    ...
    dispatch_binary_host_request(task_submitter, resource_gateway, request)
}
...
pub fn dispatch_binary_host_request(
    ...
    dispatch_decoded(task_submitter, resource_gateway, decoded)
}
