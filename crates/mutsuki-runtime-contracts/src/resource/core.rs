//! Core, protocol-owned resource descriptors and wire types.
//! This module keeps the stable contract surface for shared references, leases,
//! and read/write planning types consumed by Rust core and host layers.
...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(tag = "type", rename_all = "snake_case")]
// Boxing ResourceRef would change this public Rust contract even though JSON stayed identical.
