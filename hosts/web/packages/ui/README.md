...
- **Consumers**: web-shell import map; three vendored copies written by BotPlugins'
  `scripts/sync-mutsuki-ui-css.sh` (BotPlugins, WebHost overview, StdPlugins config), which
  `check_workspace.py` asserts stay byte-identical.
