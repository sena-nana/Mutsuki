...
def test_plugin_load_plan_profile_protocol_and_handler_binding_roundtrip() -> None:
    ...
    provides = PluginProvides(
        ...
        plugin_backends=(
            PluginBackendDescriptor(
                ...
                bridge_id="bridge.python.binary",
            ),
        ),
        codecs=(
            CodecDescriptor(
                codec_id="mutsuki.codec.typed-msgpack.v1",
                media_type="application/vnd.mutsuki.msgpack",
                version="1.0.0",
        ...
        bridges=(
            BridgeDescriptor(
                bridge_id="bridge.python.binary",
                deployment_kind=PluginDeploymentKind.PYTHON,
                codec_ids=("mutsuki.codec.typed-msgpack.v1",),
        ...
        workflows=(
            WorkflowDescriptor(
                ...
                runner_protocol_id=ProtocolId("workflow.linear.run"),
    ...
    manifest = PluginManifest(
        ...
        requires=(
            SurfaceRequirement(
                ...
                surface_id=SurfaceId("mutsuki.agent.management"),
                requirement=RequirementKind.OPTIONAL,
                binding=RequirementBinding.REBINDABLE,
            ),
        ),
    ...
    plan = RuntimeLoadPlan(
        ...
        capability_graph=RuntimeCapabilityGraph(
            ...
            active_plugin_extensions=("example.plugin.catalog",),
            ...
            active_codecs=("mutsuki.codec.typed-msgpack.v1",),
            active_bridges=("bridge.python.binary",),
