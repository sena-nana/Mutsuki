...
description: Mirror Mutsuki runtime contracts in Python, including tasks, batches, entries, runners, resources, effects, events, plugin surfaces, errors, codecs, and validation.
---

# Contract Mirror

- Treat the contracts and wire artifacts from the same Mutsuki release revision as authority; do not invent Python-only semantics.
