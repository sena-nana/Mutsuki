...
| #144 | public Agent client bridge, two-turn reuse, stream/final, cancel/reset/fork/regenerate, replay suppression, and live admin configuration | `mutsuki-plugin-bot-agent`, `mutsuki-bot-web-host-integration` | bridge/config behavior tests and ServiceRuntime QQ AI E2E |
...
| #148 | QQ domain WebExtension for live provider injection, typed actions, permissions, revision, audit and secret redaction | `mutsuki-bot-web-extension-qq` | WebHost WebSocket RPC E2E and frontend syntax check |
